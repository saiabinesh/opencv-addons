...
categories_list =  [{"supercategory": "animal", "id": 1, "name": "dead animal"}, {"supercategory": "animal", "id": 2, "name": "dead bird"}, {"supercategory": "outdoor", "id": 3, "name": "gas cylinder"},{"supercategory": "accessory", "id": 4, "name": "suitcase"},{"supercategory": "accessory", "id": 5, "name": "backpack"}]
...
# Creating validation annotations just for the first 100 images. Subsetting just the image numbers less than 100
validation_set = [x for x in validation_set if x<100]

print(validation_set)
# exit()
training_set_master = [i for i in range(1,401) if i not in validation_set]
training_set_1 = [i for i in training_set_master if i<101]
training_set_2 = [i for i in training_set_master if i>299 and i %3 == 0]
...
#Doing it for local evaluation now 
folder_path = "D:/AirSim/New/Images/Images_master_v2"

category_id_list = [[1,"dead animal", 30],[2, "dead bird", 30],[3,"gas cylinder",57],[4,"suitcase",67],[5,"backpack",116]]
