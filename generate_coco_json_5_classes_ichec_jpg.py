...
# Changing random list to 100-200 for validation and 200-1000 for training
# Changing .png to .jpg
...
def create_annotations(category_id_list, folder_path, master_json_dict, path_binary_list_of_flags, list_of_image_numbers, file_path_for_json):
	...
	for image_number in list_of_image_numbers:
		...
		"width": 1024,
		"height": 1024,
		"file_name": folder_path+"/image_"+str(image_number)+"_raw.jpg",
		"license": 1,
		"flickr_url": "none",
		"coco_url": "none",
		"date_captured": date,
...
validation_set = [i for i in range(101,201)] # need images 101-200 , cos 201 is excluded
training_set = [i for i in range(201,1001)]
folder_path = "/ichec/home/users/saiabinesh/experiments/maskrcnn/images/Images_master_jpg"
