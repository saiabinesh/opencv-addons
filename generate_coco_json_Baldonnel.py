...
seed = 30
random.seed(seed)
validation_set = random.sample(range(1,55),5)
# training_set = [i for i in range(1,401) if i not in validation_set]
training_set = [i for i in range(1,55) if i not in validation_set]
...
category_id_list = [[1,"wheelie bin", 16],[2,"suitcase",67],[3,"backpack",113],[4,"radiation barrel",18],[5,"gas cylinder",57],[6,"cable hose",16],[7,"car battery",20]]
