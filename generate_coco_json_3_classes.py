...
categories_list =  [{"supercategory": "vehicle", "id": 1, "name": "train"}, {"supercategory": "vehicle", "id": 2, "name": "truck"}, {"supercategory": "outdoor", "id": 3, "name": "gas cylinder"}]
...
def create_annotations(category_id_list, folder_path, master_json_dict, path_binary_list_of_flags):
	...
	annotation_count =1 
	for image_number in range(200,999):
...
category_id_list = [[3,"gas cylinder", 6],[1, "train", 1],[2,"truck",3]]
