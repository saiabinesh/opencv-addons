...
for z in [-20]:
	for x in np.linspace(-5860.921875/100,-22325.992188/100,10):
		for y in np.linspace( -22325.992188/100,-9456.992188/100,10):
	# for x in [78.9]:
		# for y in [-158.100]:
			...
			for roll in [0]:
				for pitch in [0]:
					...
					for idx, response in enumerate(responses):
						filename = 'D:/AirSim/New/Images/Images_master_v8/image_' +str(i)+'_raw' 
