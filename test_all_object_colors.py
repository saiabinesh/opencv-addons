...
for color in colors:
    ...
    for idx, response in enumerate(responses):
        global filename
        filename = 'D:/AirSim/New/Images/Images_master/tested_color_image_'+str(i)
    ...
    found = client.simSetSegmentationObjectID("[\w]*", color, True);
    print("Setting everything to color no." + str(color)+ "%r" % (found))
